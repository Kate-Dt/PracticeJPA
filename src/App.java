...
//        lworker.addLecture(lecture4);
        List<Lecture> resultOne = lworker.getFacultyLectures("Philosophy");
        Stream.of(resultOne).forEach(x -> System.out.println(x.toString()));
        List<Lecture> resultTwo = lworker.getFacultyLectures("Philosophy");
        Stream.of(resultTwo).forEach(x -> System.out.println(x.toString()));
